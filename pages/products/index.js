        ...
        <Center h="auto" alignItems="left">
          ...
          <Stack h="auto" w="18%" ml={"20"}>
            <Box h="auto" w="95%" m="3" ml="-0.5" mb="5">
              <Heading color="gray.600" size="lg" fontWeight={600}>
                Filter
              </Heading>
            </Box>

            <Box h="auto" w="95%" m="3" alignItems="left">
              <Heading as={"h5"} size="sm" mb="5" color="gray.600">
                Category
              </Heading>
            ...
            <Box h="auto" w="95%" m="3" alignItems="left">
              <Heading as={"h5"} size="sm" mb="5" color="gray.600" mt="5">
                Price
              </Heading>
              <RadioGroup onChange={setPrice} value={price}>
                <Stack direction="column" mb="5">
                  <Flex color="gray" justifyContent={"space-between"}>
                    Below 99{" "}
                    <Radio
                      value="0,99"
                      mt="1.5"
